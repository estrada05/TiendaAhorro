        ...
        <div class="testbox">
            ...
            <form action="controladortienda" method="POST">
                ...
                <table>
                    <tbody>
                        <tr>
                    <input style="width:420px" type="text" name="txtid_user" placeholder="Identificación del propietario"required> 
                    <br>
                    <input style="width:420px" type="text" name="txtnom_tie" placeholder="Nombre de la tienda "required> 
                    <br>
                    <input style="width:420px" type="text" name="txtdir" placeholder="Dirección" required>
                    </tr>
                    <br>
