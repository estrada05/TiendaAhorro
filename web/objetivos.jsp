...
<html class="wide wow-animation" lang="en">
    ...
    <body>
        ...
        <br>
        <br>
        <!-- Sección de los Ojetivos-->
        <section class="section-md bg-gray-lighter text-center decor-text" id="objetivos">
            <div class="container">
                <h4 class="heading-decorated">Objetivos</h4>
                <div class="row row-30 justify-content-center">
                    <div class="col-sm-10 col-lg-6">
                        <img src="images/home-var-2-650x495.jpg" alt="" width="410" height="410">    
                    </div>
                    <div class="col-sm-10 col-lg-6">
                        <!-- Blurb circle-->
                        <article class="blurb blurb-circle">
                            <div class="unit flex-row unit-spacing-md">
                                <div class="unit-left">
                                    <div class="blurb-circle__icon"><span class="icon fa fa-money"></span></div>
                                </div>
                                <div class="unit-body">
                                    <p class="blurb__title heading-6">Comparar precios</p>
                                    <p>Permitir al usuario comparar los distintos precios que manejan las tiendas de barrio para un mismo
                                        producto.</p>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="blurb blurb-circle">
                            <div class="unit flex-row unit-spacing-md">
                                <div class="unit-left">
                                    <div class="blurb-circle__icon"><span class="icon fa fa-shopping-cart"></span></div>
                                </div>
                                <div class="unit-body">
                                    <p class="blurb__title heading-6">Carro de compras</p>
                                    <p>Añadir al carrito de compras los productos que el cliente desee adquirir.</p>
                                </div>
                            </div>
                        </article>
                        <!-- Blurb circle-->
                        <article class="blurb blurb-circle">
                            <div class="unit flex-row unit-spacing-md">
                                <div class="unit-left">
                                    <div class="blurb-circle__icon"><span class="icon fa fa-list-ol"></span></div>
                                </div>
                                <div class="unit-body">
                                    <p class="blurb__title heading-6">Listas</p>
                                    <p>Publicar la lista de precios de los productos de la canasta familiar por cada tienda de barrio.</p>
                                </div>
                            </div>
                        </article>
                    </div>
