...
<html>
    ...
    <center>
        <div class="testbox">
            <br>
            <h3>Iniciar sesión como Aministrador</h3>
    ...
    <center>
            ...
            <form action="iniciaradmi" method="post">

                <input type="text" name="nombre_usuario" placeholder="Nombre" required/>
                <input type="password" name="contraseña_usuario" placeholder="Contraseña" pattern="[A-Za-z0-9]{8,20}" title="La contraseña debe tener más de 8 dígitos y menos de 20, letras mayúsculas o minúsculas, también debe contener números del 0 al 9" required/>
                <input style="border-radius:20px;font-size:17px;font-weight:bold;width:330px;height:45px" class="button button-primary button-shadow" type="submit"  name="accion"  value="Ingresar"/>
